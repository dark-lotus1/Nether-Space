package net.jinx.netherspace.entity.custom;
...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case NETHER -> ModItems.NETHER_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.NETHER.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        NETHER(ModBlocks.NETHER_PLANKS.get(), "nether");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, NETHER);
        }
    }
}
