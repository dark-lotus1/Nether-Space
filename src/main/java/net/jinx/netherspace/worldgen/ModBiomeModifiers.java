...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_TREE_NETHER = registerKey("add_tree_nether");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_TREE_NETHER, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(Tags.Biomes.IS_COLD_END),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.NETHER_PLACED_KEY)),
